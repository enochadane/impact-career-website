            ...
            <div className='carousel-inner carouselInner'>
              <div className='carousel-item active'>
                ...
                <div className='carousel-caption'>
                  ...
                  <p>
                    Our extensive and ever growing database of professionals
                    saves your HR the stress of heading hunting for specific
                    skill sets in Florida.
                  </p>
                </div>
              </div>
              <div className='carousel-item'>
                ...
                <div className='carousel-caption'>
                  ...
                  <p>
                    Whether you’re looking for a new position or want to access
                    the tech field, our training resources can upskill you or
                    help with an entry position.
                  </p>
                </div>
              </div>
              <div className='carousel-item'>
                ...
                <div className='carousel-caption'>
                  ...
                  <p>
                    Secure excellence and high performance for your business
                    with us. We listen to your requirements, implement our
                    expertise and undergo screenings, interviews, and tests.
                  </p>
                </div>
              </div>
              <div className='carousel-item'>
                ...
                <div className='carousel-caption'>
                  ...
                  <p>
                    Finding recruits for businesses and connecting professionals
                    to jobs is not our core goal. We endeavor to empower the
                    lives of locals inside and outside the workplace around us.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className='container homeEmployers'>
          ...
          <div className='row employersRow'>
            ...
            <div className='col-md-3 employersContent'>
              ...
              <p className='employersPara'>
                ...
                that cater to your budget and stop you from being overcharged
                for advice.
              </p>
            </div>
            <div className='col-md-1 bagImgCol'>
          ...
          <div className='row employersRow'>
            ...
            <div className='col-md-3 employersContent'>
              ...
              <p className='employersPara'>
                Our unmatched ecosystem of professionals allows us to provide
                you with a rich pool of tech talent when you need them.
              </p>
            </div>
            <div className='col-md-1 bagImgCol'>
              <Image
            ...
            <div className='col-md-3 employersContent'>
              ...
              <p className='employersPara'>
                Before presenting you with talent options, we do our due
                diligence by undergoing rigorous screenings and interviews.
              </p>
            </div>
            <div className='col-md-1 bagImgCol'>
              <Image

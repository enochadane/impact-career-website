    ...
    <div>
      ...
      <div className="container information">
        ...
        <p>
          ...
          materials on various sites. These pages may gather your name, address,
          email, and phone number. We may also ask you to voluntarily give us
          information about your personal or professional interests,
          demographics, experience with our services, and contact preferences to
          personalize our future messages to you and constantly enhance our
          services.
        </p>

        <p>
          For employers, we get information directly from you when you visit our
          websites, post a job opening, register for an account, edit your
          profile, seek information from us, or decide to participate in one of
          our surveys.
        </p>
        <h4>How We Use Your Information</h4>
        <p>
          We use this data to understand your requirements better and meet your
          demands. In addition, we use your information to assist you in meeting
          a goal, to get in touch with you, to keep you informed about services,
          and otherwise customize our website for you.
        </p>
        <p>
        ...
        <p>
          ...
          protecting the confidential information you submit to us. However, we
          recognize that you have a right to privacy about any personal

...
import { GET_ALL_JOBS, GET_FAQ } from '../graphql/queries';
            ...
            <div className='row'>
              ...
              <div className='col-sm-3 missionContent'>
                ...
                <p className='missionPara'>
                  Whether you're looking for work or want emerging or
                  experienced talent through your doors, your needs matter to
                  us. Through top tier technology staffing solutions, responsive
                  staffing, direct-hire, and technology executive search
                  recruiting services, we help those within Florida land
                  contracts.
                </p>
                <p>
                ...
                <div className='card cardMain'>
                  ...
                  <div className='card-body cardContent'>
                    ...
                    <p className='card-text cardText'>
                      ...
                      resources; we assist in upskilling you and get you a foot
                      in the door for entry level or high impact positions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='col-sm-4'>
                <div className='card cardMain'>
                  ...
                  <div className='card-body cardContent'>
                    ...
                    <p className='card-text cardText'>
                      Whether you're an organization, candidate, or contractor,
                      we care about your concerns and are always ready to
                      address them.
                    </p>
                  </div>
                </div>
              ...
              <div className='col-sm-4'>
                <div className='card cardMain'>
                  ...
                  <div className='card-body cardContent'>
                    ...
                    <p className='card-text cardText'>
                      With over 60 years of combined experience and rare
                      resources supplied by our team, we provide unmatched
                      opportunities, a rich network, and extensive support in
                      the tech community.
                    </p>
                  </div>
                </div>
              ...
              <div className='row mt-5 business-meet'>
                ...
                <div className='col-sm-6 contents'>
                  <div className='content-box'>
                    <p>
                      Allow us to guide and assist you in finding the perfect
                      role for you
                    </p>
                  </div>
                  <div className='content-box'>
                  ...
                  <div className='content-box'>
                    <p>
                      ...
                      finding the right job now will alleviate any past stress
                      and pain you must have had in your previous job search. So
                      do not worry, as we are here to serve you! We have the
                      best-tested methods that have helped thousands of people
                      who were once job seekers land notable roles in
                  ...
                  <div className='content-box'>
                    <p>
                      ...
                      thousands of companies and businesses. As a result, our
                      job pool constantly increases. So, there are many jobs and
              ...
              <div className='row locationRow'>
                <div className='col-sm-6'>
                  ...
                  <p className='locationPara'>
                    ...
                    run our regional offices to sort out employment prospects
                    and manage the talent pool. They can also use our extensive
                    network to provide extra services and advantages to
                    employers and job seekers.
                  </p>
                  <p className='locationPara'>
                    Our recruiting agency provides direct hire recruitment and
                    temporary and contract staffing if you are seeking to
                    employ. Additionally, if you're looking for your next
                    fantastic employment opportunity, our knowledgeable
                    recruiters can connect you with leading companies in your
                    area.
                  </p>
                </div>
                <div className='col-sm-6'>
                  ...
                  <p className='locationPara'>
                    ...
                    website information and services, we are dedicated to
                    offering an accessible website. We are still dedicated to
                    meeting the World Wide Web Consortium's WCAG 2.0 AA
                    standards for Web Content Accessibility (W3C). We keep an
                    eye out for new developments and make improvements as needed
                    since we understand that website accessibility and the WCAG
                    2.0 AA are constantly changing.
                  </p>
                  <p className='locationPara'>
                    Please get in touch with us if you have any queries
                    regarding our accessibility guidelines or are having trouble
                    using our website for any other reason
                  </p>
                </div>
              </div>
            </div>
        ...
        <div>
          <section>
            <div className='container chooseus'>
              ...
              <p>
                Whether you're looking to enter the IT industry, want to climb
                the ladder in your career, or work for us as a contractor, we
                work according to your objectives. Through constant
                communication and engagement, we familiarize your concerns and
                provide you with training resources and career counseling to
                diminish them.
              </p>

              <p>
                Through our extensive vetted employer network and proven tested
                methods, we remove any stress you may have encountered in your
                job search. Our methods have helped thousands of professionals
                land notable jobs with employers and as contractors at Impact
                Careers.
              </p>
              <p>
                ...
                <div className='timeline right timelineRight'>
                  <div className='card cardSec'>
                    <div className='card-body p-4'>
                      ...
                      <p className='timelinePara'>
                        We handle your background screenings, recruiting,
                        testing, and more to find the best professional for your
                        business, saving you the stress.
                      </p>
                    </div>
                  </div>
                </div>

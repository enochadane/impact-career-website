        ...
        <section id="contact-form">
          <div className="container">
            <div className="get-in-touch">
              <h2>Get in Touch</h2>
              <p>
                We do not believe staffing and recruiting are limited to finding
                and hiring people to fill open positions. To locate the most
                suitable consultant or client for each individual, we take the
                time to develop true connections with both parties.
              </p>
            </div>

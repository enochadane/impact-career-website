  ...
  return (
    <div>
      ...
      >
        ...
        {/* {formStatus && alert('Thank you! Your submission has been received!')}
        {selectedFile && alert('Form submission failed!!! Upload pdf only')} */}
        ...
        {loading ? (
          ...
          <button type="submit" id="sucess" className="site-btn text-center ">
            Submit
          </button>
        )}
      </form>
